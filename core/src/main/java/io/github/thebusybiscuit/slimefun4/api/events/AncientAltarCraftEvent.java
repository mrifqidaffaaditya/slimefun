 ...
 * register Bukkit listeners for {@code io.github.thebusybiscuit.slimefun4.api.events.AncientAltarCraftEvent}; without this
 * class their listener registration fails with a {@link ClassNotFoundException}.
 * <p>
 * The real {@code io.github.thebusybiscuit.slimefun5.api.events.AncientAltarCraftEvent} extends this class and reuses this
...
public class AncientAltarCraftEvent extends PlayerEvent implements Cancellable {
    ...
    protected AncientAltarCraftEvent(Player who) {
        super(who);
    }
