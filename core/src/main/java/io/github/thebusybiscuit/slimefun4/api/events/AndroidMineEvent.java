 ...
 * register Bukkit listeners for {@code io.github.thebusybiscuit.slimefun4.api.events.AndroidMineEvent}; without this
 * class their listener registration fails with a {@link ClassNotFoundException}.
 * <p>
 * The real {@code io.github.thebusybiscuit.slimefun5.api.events.AndroidMineEvent} extends this class and reuses this
...
public class AndroidMineEvent extends Event implements Cancellable {
    ...
    protected AndroidMineEvent(boolean async) {
        super(async);
    }
