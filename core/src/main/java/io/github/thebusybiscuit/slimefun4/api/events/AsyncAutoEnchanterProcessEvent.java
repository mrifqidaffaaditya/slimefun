 ...
 * register Bukkit listeners for {@code io.github.thebusybiscuit.slimefun4.api.events.AsyncAutoEnchanterProcessEvent}; without this
 * class their listener registration fails with a {@link ClassNotFoundException}.
 * <p>
 * The real {@code io.github.thebusybiscuit.slimefun5.api.events.AsyncAutoEnchanterProcessEvent} extends this class and reuses this
...
public class AsyncAutoEnchanterProcessEvent extends Event implements Cancellable {
    ...
    protected AsyncAutoEnchanterProcessEvent(boolean async) {
        super(async);
    }
