 ...
 * register Bukkit listeners for {@code io.github.thebusybiscuit.slimefun4.api.events.AsyncMachineOperationFinishEvent}; without this
 * class their listener registration fails with a {@link ClassNotFoundException}.
 * <p>
 * The real {@code io.github.thebusybiscuit.slimefun5.api.events.AsyncMachineOperationFinishEvent} extends this class and reuses this
...
public class AsyncMachineOperationFinishEvent extends Event {
    ...
    protected AsyncMachineOperationFinishEvent(boolean async) {
        super(async);
    }
