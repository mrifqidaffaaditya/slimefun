 ...
 * register Bukkit listeners for {@code io.github.thebusybiscuit.slimefun4.api.events.AutoDisenchantEvent}; without this
 * class their listener registration fails with a {@link ClassNotFoundException}.
 * <p>
 * The real {@code io.github.thebusybiscuit.slimefun5.api.events.AutoDisenchantEvent} extends this class and reuses this
...
public class AutoDisenchantEvent extends Event implements Cancellable {
    ...
    protected AutoDisenchantEvent(boolean async) {
        super(async);
    }
