 ...
 * register Bukkit listeners for {@code io.github.thebusybiscuit.slimefun4.api.events.AutoEnchantEvent}; without this
 * class their listener registration fails with a {@link ClassNotFoundException}.
 * <p>
 * The real {@code io.github.thebusybiscuit.slimefun5.api.events.AutoEnchantEvent} extends this class and reuses this
...
public class AutoEnchantEvent extends Event implements Cancellable {
    ...
    protected AutoEnchantEvent(boolean async) {
        super(async);
    }
