 ...
 * register Bukkit listeners for {@code io.github.thebusybiscuit.slimefun4.api.events.BlockPlacerPlaceEvent}; without this
 * class their listener registration fails with a {@link ClassNotFoundException}.
 * <p>
 * The real {@code io.github.thebusybiscuit.slimefun5.api.events.BlockPlacerPlaceEvent} extends this class and reuses this
...
public class BlockPlacerPlaceEvent extends BlockEvent implements Cancellable {
    ...
    protected BlockPlacerPlaceEvent(Block theBlock) {
        super(theBlock);
    }
