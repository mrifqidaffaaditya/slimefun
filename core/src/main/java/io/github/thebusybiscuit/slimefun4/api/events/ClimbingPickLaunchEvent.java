 ...
 * register Bukkit listeners for {@code io.github.thebusybiscuit.slimefun4.api.events.ClimbingPickLaunchEvent}; without this
 * class their listener registration fails with a {@link ClassNotFoundException}.
 * <p>
 * The real {@code io.github.thebusybiscuit.slimefun5.api.events.ClimbingPickLaunchEvent} extends this class and reuses this
...
public class ClimbingPickLaunchEvent extends PlayerEvent implements Cancellable {
    ...
    protected ClimbingPickLaunchEvent(Player who) {
        super(who);
    }
