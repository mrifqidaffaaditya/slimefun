 ...
 * register Bukkit listeners for {@code io.github.thebusybiscuit.slimefun4.api.events.GEOResourceGenerationEvent}; without this
 * class their listener registration fails with a {@link ClassNotFoundException}.
 * <p>
 * The real {@code io.github.thebusybiscuit.slimefun5.api.events.GEOResourceGenerationEvent} extends this class and reuses this
...
public class GEOResourceGenerationEvent extends Event {
    ...
    protected GEOResourceGenerationEvent(boolean async) {
        super(async);
    }
