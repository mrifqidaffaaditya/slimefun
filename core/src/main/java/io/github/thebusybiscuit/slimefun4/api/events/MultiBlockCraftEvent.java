 ...
 * register Bukkit listeners for {@code io.github.thebusybiscuit.slimefun4.api.events.MultiBlockCraftEvent}; without this
 * class their listener registration fails with a {@link ClassNotFoundException}.
 * <p>
 * The real {@code io.github.thebusybiscuit.slimefun5.api.events.MultiBlockCraftEvent} extends this class and reuses this
...
public class MultiBlockCraftEvent extends PlayerEvent implements Cancellable {
    ...
    protected MultiBlockCraftEvent(Player who) {
        super(who);
    }
