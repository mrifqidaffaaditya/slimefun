 ...
 * register Bukkit listeners for {@code io.github.thebusybiscuit.slimefun4.api.events.MultiBlockInteractEvent}; without this
 * class their listener registration fails with a {@link ClassNotFoundException}.
 * <p>
 * The real {@code io.github.thebusybiscuit.slimefun5.api.events.MultiBlockInteractEvent} extends this class and reuses this
...
public class MultiBlockInteractEvent extends PlayerEvent implements Cancellable {
    ...
    protected MultiBlockInteractEvent(Player who) {
        super(who);
    }
