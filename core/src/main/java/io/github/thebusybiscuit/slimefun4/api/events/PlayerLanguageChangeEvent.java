 ...
 * register Bukkit listeners for {@code io.github.thebusybiscuit.slimefun4.api.events.PlayerLanguageChangeEvent}; without this
 * class their listener registration fails with a {@link ClassNotFoundException}.
 * <p>
 * The real {@code io.github.thebusybiscuit.slimefun5.api.events.PlayerLanguageChangeEvent} extends this class and reuses this
...
public class PlayerLanguageChangeEvent extends Event {
    ...
    protected PlayerLanguageChangeEvent(boolean async) {
        super(async);
    }
