 ...
 * register Bukkit listeners for {@code io.github.thebusybiscuit.slimefun4.api.events.PlayerPreResearchEvent}; without this
 * class their listener registration fails with a {@link ClassNotFoundException}.
 * <p>
 * The real {@code io.github.thebusybiscuit.slimefun5.api.events.PlayerPreResearchEvent} extends this class and reuses this
...
public class PlayerPreResearchEvent extends Event implements Cancellable {
    ...
    protected PlayerPreResearchEvent(boolean async) {
        super(async);
    }
