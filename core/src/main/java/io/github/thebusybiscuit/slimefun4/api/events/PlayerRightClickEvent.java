 ...
 * register Bukkit listeners for {@code io.github.thebusybiscuit.slimefun4.api.events.PlayerRightClickEvent}; without this
 * class their listener registration fails with a {@link ClassNotFoundException}.
 * <p>
 * The real {@code io.github.thebusybiscuit.slimefun5.api.events.PlayerRightClickEvent} extends this class and reuses this
...
public class PlayerRightClickEvent extends PlayerEvent {
    ...
    protected PlayerRightClickEvent(Player who) {
        super(who);
    }
