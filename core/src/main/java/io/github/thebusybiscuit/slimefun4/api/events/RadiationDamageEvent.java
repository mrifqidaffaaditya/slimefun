 ...
 * register Bukkit listeners for {@code io.github.thebusybiscuit.slimefun4.api.events.RadiationDamageEvent}; without this
 * class their listener registration fails with a {@link ClassNotFoundException}.
 * <p>
 * The real {@code io.github.thebusybiscuit.slimefun5.api.events.RadiationDamageEvent} extends this class and reuses this
...
public class RadiationDamageEvent extends Event implements Cancellable {
    ...
    protected RadiationDamageEvent(boolean async) {
        super(async);
    }
