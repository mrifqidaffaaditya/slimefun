 ...
 * register Bukkit listeners for {@code io.github.thebusybiscuit.slimefun4.api.events.ReactorExplodeEvent}; without this
 * class their listener registration fails with a {@link ClassNotFoundException}.
 * <p>
 * The real {@code io.github.thebusybiscuit.slimefun5.api.events.ReactorExplodeEvent} extends this class and reuses this
...
public class ReactorExplodeEvent extends Event {
    ...
    protected ReactorExplodeEvent(boolean async) {
        super(async);
    }
