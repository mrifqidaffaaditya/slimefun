 ...
 * register Bukkit listeners for {@code io.github.thebusybiscuit.slimefun4.api.events.ResearchUnlockEvent}; without this
 * class their listener registration fails with a {@link ClassNotFoundException}.
 * <p>
 * The real {@code io.github.thebusybiscuit.slimefun5.api.events.ResearchUnlockEvent} extends this class and reuses this
...
public class ResearchUnlockEvent extends Event implements Cancellable {
    ...
    protected ResearchUnlockEvent(boolean async) {
        super(async);
    }
