 ...
 * register Bukkit listeners for {@code io.github.thebusybiscuit.slimefun4.api.events.SlimefunBlockBreakEvent}; without this
 * class their listener registration fails with a {@link ClassNotFoundException}.
 * <p>
 * The real {@code io.github.thebusybiscuit.slimefun5.api.events.SlimefunBlockBreakEvent} extends this class and reuses this
...
public class SlimefunBlockBreakEvent extends Event implements Cancellable {
    ...
    protected SlimefunBlockBreakEvent(boolean async) {
        super(async);
    }
