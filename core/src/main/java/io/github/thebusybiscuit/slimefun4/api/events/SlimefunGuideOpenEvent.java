 ...
 * register Bukkit listeners for {@code io.github.thebusybiscuit.slimefun4.api.events.SlimefunGuideOpenEvent}; without this
 * class their listener registration fails with a {@link ClassNotFoundException}.
 * <p>
 * The real {@code io.github.thebusybiscuit.slimefun5.api.events.SlimefunGuideOpenEvent} extends this class and reuses this
...
public class SlimefunGuideOpenEvent extends Event implements Cancellable {
    ...
    protected SlimefunGuideOpenEvent(boolean async) {
        super(async);
    }
