 ...
 * register Bukkit listeners for {@code io.github.thebusybiscuit.slimefun4.api.events.SlimefunItemRegistryFinalizedEvent}; without this
 * class their listener registration fails with a {@link ClassNotFoundException}.
 * <p>
 * The real {@code io.github.thebusybiscuit.slimefun5.api.events.SlimefunItemRegistryFinalizedEvent} extends this class and reuses this
...
public class SlimefunItemRegistryFinalizedEvent extends Event {
    ...
    protected SlimefunItemRegistryFinalizedEvent(boolean async) {
        super(async);
    }
