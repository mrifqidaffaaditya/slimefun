 ...
 * register Bukkit listeners for {@code io.github.thebusybiscuit.slimefun4.api.events.SlimefunItemSpawnEvent}; without this
 * class their listener registration fails with a {@link ClassNotFoundException}.
 * <p>
 * The real {@code io.github.thebusybiscuit.slimefun5.api.events.SlimefunItemSpawnEvent} extends this class and reuses this
...
public class SlimefunItemSpawnEvent extends Event implements Cancellable {
    ...
    protected SlimefunItemSpawnEvent(boolean async) {
        super(async);
    }
