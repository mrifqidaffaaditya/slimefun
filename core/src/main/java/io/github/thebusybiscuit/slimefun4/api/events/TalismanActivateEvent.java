 ...
 * register Bukkit listeners for {@code io.github.thebusybiscuit.slimefun4.api.events.TalismanActivateEvent}; without this
 * class their listener registration fails with a {@link ClassNotFoundException}.
 * <p>
 * The real {@code io.github.thebusybiscuit.slimefun5.api.events.TalismanActivateEvent} extends this class and reuses this
...
public class TalismanActivateEvent extends PlayerEvent implements Cancellable {
    ...
    protected TalismanActivateEvent(Player who) {
        super(who);
    }
