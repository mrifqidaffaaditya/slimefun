 ...
 * register Bukkit listeners for {@code io.github.thebusybiscuit.slimefun4.api.events.WaypointCreateEvent}; without this
 * class their listener registration fails with a {@link ClassNotFoundException}.
 * <p>
 * The real {@code io.github.thebusybiscuit.slimefun5.api.events.WaypointCreateEvent} extends this class and reuses this
...
public class WaypointCreateEvent extends PlayerEvent implements Cancellable {
    ...
    protected WaypointCreateEvent(Player who) {
        super(who);
    }
